...
$env:POSE_PLAN_CONFIG = "data\reconstruction_capture_plans\scene_3.1\scene_3.1_reconstruction_manifest.json"
$env:LAYERS_CONFIG = $null
$env:SESSION_ID = "scene_3.1_reconstruction"
...
if ($ExitCode -ne 0) {
    throw "Scene 3.1 reconstruction capture GUI exited with code $ExitCode."
}
