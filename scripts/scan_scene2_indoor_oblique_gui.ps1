...
$env:POSE_PLAN_CONFIG = "data\reconstruction_capture_plans\scene_2_indoor_oblique\scene_2_indoor_oblique_pose_plan.json"
$env:LAYERS_CONFIG = $null
$env:SESSION_ID = "scene_2_indoor_oblique_reconstruction"
...
if ($ExitCode -ne 0) {
    throw "Scene 2 indoor oblique capture GUI exited with code $ExitCode."
}
