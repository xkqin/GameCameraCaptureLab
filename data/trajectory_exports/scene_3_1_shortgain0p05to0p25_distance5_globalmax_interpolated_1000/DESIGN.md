# scene_3.1 Terminal-Gain Interpolated Preview
...
- Every trajectory ends at the single measured global maximum, score 6.873469.
...
- All 48 materialized interpolation frames have `score=null`, `raw_score=null`, and `estimated_score=null`.
- No interpolated value is presented as measured aesthetic evidence.

## Geometry

- All 1 eligible measured start families inside the configured radius are used.
...
- 50 replay keyframes at 0.10 seconds per step.
