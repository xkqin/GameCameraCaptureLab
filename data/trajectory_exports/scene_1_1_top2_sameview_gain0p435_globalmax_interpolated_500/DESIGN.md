# scene_1.1 Terminal-Gain Interpolated Preview

This is an experimental replay candidate set. It does not replace any accepted trajectory directory.

## Objective

- Generate 500 short, smooth candidate motions from measured high-score starts.
- Every trajectory ends at the single measured global maximum, score 7.127104.
...
- All 22 materialized interpolation frames have `score=null`, `raw_score=null`, and `estimated_score=null`.
- No interpolated value is presented as measured aesthetic evidence.

## Geometry

- All 2 eligible measured start families inside the configured radius are used.
...
- 24 replay keyframes at 0.10 seconds per step.
