...
EXPECTED_FILES="${EXPECTED_FILES:-40001}"
LOG_FILE="${LOG_FILE:-${SCRIPT_DIR}/rclone_upload_scene_1_2_10000_half.log}"
STATUS_FILE="${STATUS_FILE:-${SCRIPT_DIR}/rclone_upload_scene_1_2_10000_half.status}"
LOCK_FILE="${LOCK_FILE:-${SCRIPT_DIR}/.rclone_upload_scene_1_2_10000_half.lock}"
